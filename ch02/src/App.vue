  ...
  data() {
    return {
      ...
      people: [
        ...
        { uid: "a103", name: "강감찬", age: 33 },
        { uid: "a104", name: "이순신", age: 43 },
        { uid: "a105", name: "장보고", age: 53 },
      ],
      value1: "tit1",
      value2: "tit2",
      count: 0,
      ...
      myStyle: { width: "100px", height: "100px", backgroud: "orange" },
      myName: "홍길동",
      myText: "",
      myCheck: false,
      myCities: [],
...
<template>
  ...
  <ul>
    <li v-for="city in cities">i : {{ city }}</li>
  </ul>
